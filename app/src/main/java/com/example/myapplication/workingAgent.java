...
public class workingAgent extends AppCompatActivity {
...
MyAdapter adapter;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(workingAgent.this, Admin_panel.class));
   finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_working_agent);
